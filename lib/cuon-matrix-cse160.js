...
class Vector3 {
    ...
    magnitude() {
        // Insert your code here.;
        let a = Math.pow(this.elements[0], 2);
        let b = Math.pow(this.elements[1], 2);
        let c = Math.pow(this.elements[2], 2);
        
        let m = Math.sqrt(a + b + c); // Modify this line to calculate this vector's magnitude.
    ...
    normalize() {
        ...
        this.elements[0] = Number(this.elements[0]) / m;
        this.elements[1] = Number(this.elements[1]) / m;
        this.elements[2] = Number(this.elements[2]) / m;
